...
class SendMail(object):
    ...
    def def_mail(self):
        ...
        if self.file:  #处理附件的
            ...
            try:
                ...
                new_file_name = '=?utf-8?b?' + base64.b64encode(
    ...
    def mymail(self):
        m = SendMail(
            ...
            title='测试报告',
            content='恭喜测试完成！附件为详细测试用例。测试报告查看：http://94.191.124.146/TheFame/report/report.html 。测试用例下载：http://94.191.124.146/TheFame/case/case.xlsx',
